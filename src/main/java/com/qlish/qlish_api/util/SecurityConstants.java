...
public class SecurityConstants {
    public static final Long JWT_EXPIRATION_DATE = 172800000L; // 2 days
    public static final Long REFRESH_TOKEN_EXPIRATION_DATE = 86400000L; // 1 day
    ...
    public static String SECRET_KEY = System.getenv("JWT_SECRET_KEY");
}
