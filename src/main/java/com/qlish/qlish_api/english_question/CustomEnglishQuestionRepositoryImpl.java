...
public class CustomEnglishQuestionRepositoryImpl implements CustomEnglishQuestionRepository {
    ...
    @Override
    public Page<EnglishQuestionEntity> findQuestionsByCriteria(Pageable pageable, String questionLevel, String questionClass, String questionTopic, int testSize) {
